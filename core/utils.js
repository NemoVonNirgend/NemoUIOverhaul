...
// 1. CONSTANTS
export const LOG_PREFIX = `[NemoUIOverhaul]`;
export const NEMO_EXTENSION_NAME = "NemoUIOverhaul";
...
// 2. PATH HELPERS
/**
 * Get the full path to a file within the NemoUIOverhaul extension directory.
 * Use this instead of hardcoding 'scripts/extensions/third-party/NemoUIOverhaul/...' everywhere.
