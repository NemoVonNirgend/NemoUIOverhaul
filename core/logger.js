/**
 * NemoUIOverhaul - Centralized Logging Utility
...
class Logger {
    constructor(prefix = 'NemoUIOverhaul', level = CONSTANTS.LOG_LEVELS.INFO) {
        this.prefix = prefix;
        this.level = level;
...
if (isDebugEnabled()) {
    ...
    console.log('[NemoUIOverhaul] Debug mode enabled');
}

// Export utility to toggle debug mode at runtime
// Usage: window.NemoUIOverhaulLogger.enableDebug() or .disableDebug()
if (typeof window !== 'undefined') {
    window.NemoUIOverhaulLogger = {
        enableDebug: () => {
            logger.setDebugMode(true);
            try { localStorage.setItem('nemoPresetExtDebug', 'true'); } catch (e) {}
            console.log('[NemoUIOverhaul] Debug mode enabled (persisted to localStorage)');
        },
        disableDebug: () => {
            logger.setDebugMode(false);
            try { localStorage.removeItem('nemoPresetExtDebug'); } catch (e) {}
            console.log('[NemoUIOverhaul] Debug mode disabled');
        },
        getLogger: () => logger
    };
}
