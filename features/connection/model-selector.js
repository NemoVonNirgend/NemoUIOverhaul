/**
 * NemoUIOverhaul - Enhanced Model Selector (Orchestrator)
 *
...
const NEMO_EXTENSION_NAME = 'NemoUIOverhaul';
...
export const ModelSelector = {
    ...
    initialize() {
        ...
        if (!document.querySelector('link[href*="model-selector.css"]')) {
            ...
            link.rel = 'stylesheet';
            link.href = 'scripts/extensions/third-party/NemoUIOverhaul/features/connection/model-selector.css';
        ...
        if (!document.querySelector('link[href*="pipeline-settings.css"]')) {
            ...
            pipeLink.href = 'scripts/extensions/third-party/NemoUIOverhaul/features/connection/pipeline-settings.css';
        ...
        if (!document.querySelector('link[href*="proxy-manager.css"]')) {
            ...
            proxyLink.href = 'scripts/extensions/third-party/NemoUIOverhaul/features/connection/proxy-manager.css';
