...
- Character location and physical description â€” where are they, what are they doing, what is their physical state?
- Emotional state, internal thoughts, goals, and feelings â€” infer these even if not verbally stated
...
- What is the subtext â€” what is NOT being said but is present in the scene?
...
- CHARACTER VOICES: How does each character SOUND? Analyze their speech patterns, vocabulary, cadence, and verbal habits from the conversation so far. Note: Does one character use short sentences? Formal language? Slang? Sarcasm? Silence? Do they curse, deflect with humor, speak in metaphors? How does their voice differ from the other characters? The writing team MUST maintain these distinct voices â€” characters should never sound interchangeable.
...
Be specific and grounded in what has been established. Do NOT write prose or dialogue â€” only analysis.
...
- ${userName} is exempt from your writing â€” never assume what they do, say, think, or feel.
...
- PACING: Stop at natural cut-in points where ${userName} would respond. Do not skip forward in time during active interaction. End at a moment that invites ${userName} to act.`;
     ...
     */
    getAntiSlopRules() {
        return `[ANTI-SLOP â€” Banned patterns. Do NOT use ANY of the following]
...
[SCENE CONTEXT â€” from recall analysis]
${recallContext}

[CHARACTER ANALYSIS â€” internal states, subtext, and psychological dynamics]
${characterAnalysis}
...
IMPORTANT: These drafts were written by smaller models that only received a summarized version of the conversation context. They may contain hallucinations, inaccuracies, or details that contradict the established story. YOU have the full, authoritative context. Use the drafts for their prose style, creative ideas, and phrasing â€” but always defer to the actual conversation history and system context for facts, character details, continuity, and established canon. If a draft invents something that contradicts what actually happened, discard that element.
...
- Do NOT make excessive or illogical time skips. If characters are actively talking or in the middle of a moment, do not skip forward in time. Time skips are fine for travel, waiting, or transitions between scenes â€” NOT in the middle of active interaction.
...
${antiSlop}`;
        ...
        return [
            ...
            { role: 'system', content: `[CHARACTER ANALYSIS â€” internal states, subtext, and psychological dynamics]\n${characterAnalysis}` },
            ...messages,
